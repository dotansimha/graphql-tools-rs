...
pub struct TypeInfo {
    pub objects_stack: Vec<schema::ObjectType>,
}

impl TypeInfo {
    pub fn new() -> Self {
        return TypeInfo {
            objects_stack: Vec::new(),
        };
    }

    fn get_type(&self) -> Option<&schema::ObjectType> {
        self.objects_stack.last()
    }

    fn enter_type(&mut self, object: schema::ObjectType) {
